...
The Western Armenian UD treebank is based on the Western Armenien section of the Armenian Dependency Treebank (Հայերէնի Ծառադարան), developed for UD originally by the ArmTDP team led by Marat M. Yavrumyan at the Yerevan State University.

# Introduction

UD_Western_Armenian-ArmTDP is based on the Հայերէնի Ծառադարան dataset (version 1.0), a mix of random sentences sampled from different sources and representing different genres and domains, released in several formats (local on-line newspaper and journal articles, fiction dated between 1895 and 2019). The treebank consists 1780 sentences (~36K tokens).
...
The team behind the UD_Armenian-ArmTDP: Marat M. Yavrumyan, Hrant H. Khachatrian, Anna S. Danielyan, Setrag H.M. Hovsepian Liana G. Minasyan.
